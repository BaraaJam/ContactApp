...
public class ContactManagerTest {
    ...
    void testGetContactById_Success() {
        ...
        manager.contactAdd("John Doe", "0763007777");
        ...
        assertEquals("John Doe", foundContact.getContactName(), "The retrieved name should match.");
    }
